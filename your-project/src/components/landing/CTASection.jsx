    ...
    <section className="py-24 bg-gradient-to-b from-background via-gray-50 to-background relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
        <motion.div
          ...
          className="p-12 sm:p-16 rounded-[2rem] bg-gradient-to-br from-white to-gray-50 border border-primary/20 shadow-2xl shadow-primary/5 relative overflow-hidden"
        >

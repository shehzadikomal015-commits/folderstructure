    ...
    <div className="min-h-screen bg-gray-50/50">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <p className="text-muted mt-1">Track and manage your orders</p>
        </motion.div>
        ...
        {error && !loading && (
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="bg-danger-light border border-danger/20 rounded-2xl p-6 mb-6"
          >
            ...
            <div className="space-y-4">
              {filteredOrders.map((order, idx) => (
                <motion.div
                  ...
                  className="bg-white rounded-2xl border border-border p-6 hover:shadow-lg hover:shadow-primary/5 transition-all cursor-pointer"
